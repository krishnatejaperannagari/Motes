...
import me.futuretechnology.motes.adapter.NotesAdapter;
import me.futuretechnology.motes.callbacks.NavigationDrawerCallbacks;
import me.futuretechnology.motes.fragment.NavigationDrawerFragment;
    ...
    private void firstRunInit(){
        initSimpleNote("Inline #hashtag",
                "Use #hashtag and @mentions anywhere in your #notes. " +
                        "Motes automatically indexes and groups them together in the sidebar for quick access.");
